...
//        type为0时表示搜索全部
    ...
    public boolean bindCard(String userId, WaterCard waterCard, String remark) {
        ...
        temp.setStatus(1);
        return mapper.updateByPrimaryKeySelective(temp) > 0;
    }
    ...
    public boolean changeCard(String cardId, String newCardCode, String newPassword, String remark) {
        ...
        return mapper.updateByPrimaryKeySelective(newCard) > 0;
    }
    ...
    public boolean bind(String watermeterCode, String cardNo) {

        WaterCard waterCard = new WaterCard();
        waterCard.setWatermeterCode(cardNo);
        waterCard = mapper.selectOne(waterCard);
        waterCard.setWatermeterCode(watermeterCode);
        return mapper.updateByPrimaryKeySelective(waterCard) > 0;
